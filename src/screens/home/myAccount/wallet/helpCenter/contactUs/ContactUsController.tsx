...
import { ICON_CONCTACTUSBYPHONE, ICON_CONCTACTUSBYEMAIL } from 'assets/images';
...
const ContactUsController: React.FC = () => {
  ...
  const contactUsValues = [
    ...
    { img: ICON_CONCTACTUSBYEMAIL, mainText: 'Envía un correo electrónico', description: 'Responderemos lo antes posible.' }
  ];
