...
const ShopCartScreen: React.FC<Props> = ({ onPressMyAccount, onPressInvoice, onPressLogOut, productsss }) => {
  ...
  const ItemsList: React.FC = ({ itemsListArray: []}) => {
    return (
      <Container>
        <CustomText text="Carrito de compras"></CustomText>
        {
          itemsListArray.map(
            (item) => {
              return (
    ...
    return (
      <Container flex row center>
        <Container flex center>
          <Image source={IMG_PRODUCT1} style={{ marginTop: 10, width: 80, height: 88 }} />
        </Container>
        <Container flex>
          <Container flex>
            <Container>
              <CustomText text="Papitas fritas 205 gr."></CustomText>
              <CustomText text="45.0 USD"></CustomText>
            </Container>
            <Container flex row>
            ...
            <Container row space="between">
              <Container>
                <Button
                  ...
                  size="medium"
                  transparent="true"
                  leftIcon={<Image source={ICONN_DELETE_SHOPPING_CART_ITEM} style={{ left: 5 }} />}
                >
                  Eliminar
                </Button>
              </Container>
              ...
              >
                <Button fontSize="h4" size="small" transparent="true" fontBold="true">
                  -
                </Button>
                <Button fontSize="h6" size="small" transparent="true" color="iconn_black_original">
                  1
                </Button>
                <Button fontSize="h5" size="small" transparent="true">
                  +
                </Button>
              </Container>
            </Container>
    ...
    <Container flex crossCenter style={{ backgroundColor: theme.brandColor.iconn_light_grey }}>
      ...
      >
        ...
        <Container center style={{ backgroundColor: theme.brandColor.iconn_light_grey }}>
          ...
          >
            <Button transparent="true" fontSize="h5" length="long" leftIcon={<Image source={ICONN_EMPTY_SHOPPING_CART} />} color="grey">
              Vaciar canasta
            </Button>
          </Container>
          <CustomText text=""></CustomText>
  ...
  return (
    <Container flex crossCenter center style={{ marginTop: 34, backgroundColor: theme.fontColor.white }}>
      ...
      <Button fontSize="h6" transparent="true" size="ssmall" color="iconn_black_original" marginLeft={40}>
        X
      </Button>
