...
export class VtexFavoritesPatchApi extends HttpClient {
  static classInstance?: VtexFavoritesPatchApi;
  ...
  private constructor() {
    ...
    super(VTEXApiFavConfig('favorites'));
    ...
    this.instance.interceptors.request.use(
      (request: any) => {
        ...
        console.log(
          'INTERCEPTOR - Starting PATCH FAVORITES Request ===> \n\n',
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new VtexFavoritesPatchApi();
    }
