...
export class PickUpPoints extends HttpClient {
  
  static classInstance?: PickUpPoints;

  private constructor() {
    // console.log(
    //   'AxiosRequestConfig ===> VTEXApiConfig ===> \n\n',
    //   JSON.stringify(VTEXApiConfig('reviews'), null, 3)
    // );

    super(VTEXApiConfig('pickUpPoints'));
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new PickUpPoints();
    }
