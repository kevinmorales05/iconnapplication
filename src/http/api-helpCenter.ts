...
export class HelpCenterApi extends HttpClient {
  static classInstance?: HelpCenterApi;

  private constructor() {
    if (global.showLogs__api_invoicing) {
      // console.log('AxiosRequestConfig ===> ApiConfig ===> \n\n', JSON.stringify(ApiConfig('helpCenter'), null, 3));
    }

    super(ApiConfig('helpCenter'));
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new HelpCenterApi();
    }
