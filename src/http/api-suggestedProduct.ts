...
export class SuggestedProducts extends HttpClient {
  static classInstance?: SuggestedProducts;
  ...
  private constructor() {
    ...
    super(VTEXApiConfig('suggestedProducts'));
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new SuggestedProducts();
    }
