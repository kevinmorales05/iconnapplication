...
export class PromotionsApi extends HttpClient {
  static classInstance?: PromotionsApi;

  private constructor() {
    if (global.showLogs__api_promotions) {
      console.log('AxiosRequestConfig ===> VTEXApiConfig ===> \n\n', JSON.stringify(VTEXApiConfig('promotions'), null, 3));
    }

    super(VTEXApiConfig('promotions'));
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new PromotionsApi();
    }
