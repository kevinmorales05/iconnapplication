...
export class EstafetaApi extends HttpClient {
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new EstafetaApi();
    }
