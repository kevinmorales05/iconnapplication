...
export class Products extends HttpClient {
  static classInstance?: Products;

  private constructor() {
    if (global.showLogs__api_products) {
      console.log('AxiosRequestConfig ===> VTEXApiConfig ===> \n\n', JSON.stringify(VTEXApiConfig('products'), null, 3));
    }

    super(VTEXApiConfig('products'));
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new Products();
    }
