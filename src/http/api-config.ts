...
const API_URL_USERS = 'https://api-users-uat.apps-backend.iconn.com.mx';
const API_URL_OTPS = 'https://api-otps-uat.apps-backend.iconn.com.mx';
const API_URL_INVOICING = 'https://api-invoicing-uat.apps-backend.iconn.com.mx';
