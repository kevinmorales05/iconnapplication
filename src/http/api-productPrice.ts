...
export class ProductPrice extends HttpClient {
  static classInstance?: ProductPrice;

  private constructor() {
    console.log('AxiosRequestConfig ===> VTEXApiConfig ===> \n\n', JSON.stringify(VTEXApiConfig('productPrice'), null, 3));

    super(VTEXApiConfig('productPrice'));
  ...
  public static getInstance() {
    if (!this.classInstance) {
      this.classInstance = new ProductPrice();
    }
